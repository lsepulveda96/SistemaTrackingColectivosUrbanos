...
public class LineaController {
     ...
     * );
     * response = new Response<List<Parada>>( false, 200, "Paradas de recorrido " +
     * recorridoActual.getId(), paradasRecorrido );
     * }
     * else {
     * response = new Response<List<Parada>>( true, 400,
     * "No se encontro recorrido actual para linea " + id, null );
     * }
     * return Mapper.getResponseAsJson(response);
     * }
     */
     ...
     * 
     * Response<List<Recorrido>> response = new Response<List<Recorrido>>( false,
     * 200, "Recorridos de linea " + id, recorridos );
     * return Mapper.getResponseAsJson(response);
     * }
     */
     ...
     * 
     * if (recorrido != null)
     * resp = new Response<RecorridoDTO>( false, 200, "Recorrido actual de linea: "
     * + idlinea, new RecorridoDTO( recorrido ) );
     * else
     * resp = new Response<RecorridoDTO>( true, 300,
     * "No se encontro recorrido para linea " + idlinea, null );
     * 
    ...
    /**
     * Recupera un recorrido por su id.
     * 
     * @param idrecorrido
     * @return
     */
