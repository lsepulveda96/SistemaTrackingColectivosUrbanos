...
export class ColectivoEditComponent implements OnInit {
  ...
  anioIC = new UntypedFormControl(null, Validators.pattern('^[12]{1}[09]{1}[0-9]{2}$') ); // 19xx o 20xx
  capacidadIC = new UntypedFormControl(null, Validators.pattern('^[1-9][0-9]?$') ); // numero entre 1 y 100
